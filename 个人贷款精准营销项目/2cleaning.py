...
#%%
t=accepts.describe().T
#%%
fill_cols = ['tot_open_tr']
fill_values = {col: accepts[col].median for col in fill_cols}#连续变量用均值或中位数
#fill_values = {col: bank[col].mode()[0] for col in fill_cols}#分类变量用众数
#数据清洗
accepts= accepts.fillna(fill_values)
